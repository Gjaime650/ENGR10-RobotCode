...
#pragma config(Motor,  port6,           secondArmMotor, tmotorServoContinuousRotation, openLoop, reversed)
...
task main(){
	...
	startMotor(armMotor,70);
	startMotor(secondArmMotor,70);
	wait(2);
	stopMotor(armMotor);
